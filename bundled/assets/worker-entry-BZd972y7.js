...
function useFetcher({
  ...
  let unstable_reset = reactExports.useCallback((opts) => router.resetFetcher(fetcherKey, opts), [router, fetcherKey]);
...
function ErrorWrapper({
  ...
  ), /* @__PURE__ */ React.createElement("title", null, title2)), /* @__PURE__ */ React.createElement("body", null, /* @__PURE__ */ React.createElement("main", { style: { fontFamily: "system-ui, sans-serif", padding: "2rem" } }, children)));
}
...
const requestHandler = createRequestHandler(
  () => import("./server-build-CMkMVO7f.js"),
  "production"
);
const app = {
